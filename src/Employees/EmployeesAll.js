...
const EmployeesAll = (props) => {
    ...
    const handleSearch = (page) => {
        EmployeeServices.getCountEmployees(page).then((res) => {
            setEmployees(res.data.employees.data);
            setCurrent_page(res.data.employees.current_page);
            setLast_page(res.data.employees.last_page);
            setTotal(res.data.employees.total);
                                ...
                                {employees != null &&
                                    ...
                                    employees.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{item.city}</td>
                                            <td>{item.address}</td>
                                            {user != null && user.name == item.user.name &&
                                                <td>
                                                    ...
                                                    <Link to={`/salary/report/${item.id}`}>
                                                        <i
                                                            className="fas fa-money-bill-alt text-warning"
                                                            title="Salary Report"
                                                        ></i>
                                                    </Link>
                                                </td>
